...
## 2. Quy Trắc Kiểm Tra Kết Quả (Assertions Standard)
...
- Masking Sensitve Data: Tự động ẩn hoặc làm mờ (masking) thông tin nhạy cảm (Password, Token, Credit Card) trong log file và test execution reports.
