...
public class Authentications {
	...
	void testBearerTokenAuthentication() {
		// Nhập personal access token (PAT) thật của bạn nếu muốn chạy thực tế
		String bearerToken = "ghp_yourPersonalAccessTokenHere";
	...
	void testOAuth2Authentication() {
		given()
				.auth().oauth2("ghp_yourPersonalAccessTokenHere")
				.when()
				.get("https://api.github.com/user/repos")
				.then()
				.statusCode(200)
